...
namespace IronBloodSiege.Message
{
    public static class IbsMessage
    {
        ...
        private static readonly TextObject RamDestroyedText = new TextObject("{=ibs_msg_ram_destroyed}Ram Destroyed");
        ...
        private static readonly TextObject CanRetreatText = new TextObject("{=ibs_msg_can_retreat}The attacking soldiers have suffered too many casualties and are about to be routed.");
